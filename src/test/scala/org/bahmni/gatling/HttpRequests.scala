...
object HttpRequests {
  ...
  def createPatientRequest: HttpRequestBuilder = {
    http("create patient")
      ...
      .body(RawFileBody("bangladesh.json"))
      .asJSON
  }
  ...
  def startVisitRequest(patient_uuid : String): HttpRequestBuilder = {
    http("start visit")
      ...
      .body(StringBody(s"""{"patient":"$patient_uuid","visitType":"d6170654-e989-40bd-a00b-f0a697313e79","location":"29b4e47a-97fa-4956-a51c-8a6ba38d2b83"}"""))
      .asJSON
  }

  def getOrderedSamples(accession_num: String): HttpRequestBuilder = {
    http("view lab order")
      .get("/openelis/AccessionResults.do")
      .queryParam("accessionNumber", accession_num)
      .queryParam("referer", "LabDashboard")
  }

  def getQuotations(): HttpRequestBuilder = {
    http("get quotation")
      .get("/#")
      .queryParam("id","85639")
      .queryParam("view_type","form")
      .queryParam("model","sale.order")
      .queryParam("menu_id","296")
      .queryParam("action","372")
  }
}
